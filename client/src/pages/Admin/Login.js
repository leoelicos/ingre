...
const App = () => {
  ...
  return (
    <div>
      ...
      <Divider></Divider>
      <ContentTitle>
        Login to <FontAwesomeIcon className="ingre-logo" icon="fa-solid fa-egg" style={{ margin: '0 0.3rem 0 0.6rem', color: 'var(--ingre-eggshell)', fontSize: '1.8rem', paddingBottom: '2px' }} />
